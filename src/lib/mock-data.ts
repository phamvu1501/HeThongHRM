...
export const mockAttendances: Attendance[] = [
  // Jan 2026
  { attendance_id: 'A001', work_date: '2026-01-02', employee_id: 'E001', shift_id: 'SH001', check_in: '07:58', check_out: '17:32', work_minutes: 510, overtime_minutes: 0, status: 'Đúng giờ', note: '' },
  { attendance_id: 'A002', work_date: '2026-01-02', employee_id: 'E002', shift_id: 'SH001', check_in: '08:20', check_out: '17:30', work_minutes: 490, overtime_minutes: 0, status: 'Đi trễ', note: 'Kẹt xe' },
  { attendance_id: 'A003', work_date: '2026-01-02', employee_id: 'E003', shift_id: 'SH001', check_in: '07:55', check_out: '20:00', work_minutes: 510, overtime_minutes: 150, status: 'Tăng ca', note: 'Deadline dự án' },
  { attendance_id: 'A004', work_date: '2026-01-02', employee_id: 'E004', shift_id: 'SH001', check_in: '08:00', check_out: '17:30', work_minutes: 510, overtime_minutes: 0, status: 'Đúng giờ', note: '' },
  { attendance_id: 'A005', work_date: '2026-01-02', employee_id: 'E005', shift_id: 'SH001', check_in: '', check_out: '', work_minutes: 0, overtime_minutes: 0, status: 'Vắng mặt', note: 'Chưa xin phép' },
  { attendance_id: 'A006', work_date: '2026-01-03', employee_id: 'E001', shift_id: 'SH001', check_in: '07:59', check_out: '17:31', work_minutes: 510, overtime_minutes: 0, status: 'Đúng giờ', note: '' },
  { attendance_id: 'A007', work_date: '2026-01-03', employee_id: 'E003', shift_id: 'SH001', check_in: '08:00', check_out: '19:30', work_minutes: 510, overtime_minutes: 120, status: 'Tăng ca', note: '' },
  { attendance_id: 'A008', work_date: '2026-01-03', employee_id: 'E002', shift_id: 'SH001', check_in: '08:05', check_out: '17:30', work_minutes: 505, overtime_minutes: 0, status: 'Đúng giờ', note: '' },
  { attendance_id: 'A009', work_date: '2026-01-06', employee_id: 'E001', shift_id: 'SH001', check_in: '08:00', check_out: '17:30', work_minutes: 510, overtime_minutes: 0, status: 'Đúng giờ', note: '' },
  { attendance_id: 'A010', work_date: '2026-01-06', employee_id: 'E006', shift_id: 'SH001', check_in: '08:02', check_out: '17:00', work_minutes: 478, overtime_minutes: 0, status: 'Về sớm', note: 'Họp ngoài' },
  { attendance_id: 'A011', work_date: '2026-01-07', employee_id: 'E001', shift_id: 'SH001', check_in: '07:55', check_out: '17:30', work_minutes: 514, overtime_minutes: 0, status: 'Đúng giờ', note: '' },
  { attendance_id: 'A012', work_date: '2026-01-07', employee_id: 'E009', shift_id: 'SH001', check_in: '08:00', check_out: '17:30', work_minutes: 510, overtime_minutes: 0, status: 'Đúng giờ', note: '' },
  // Feb 2026
  { attendance_id: 'A013', work_date: '2026-02-02', employee_id: 'E001', shift_id: 'SH001', check_in: '07:58', check_out: '17:30', work_minutes: 510, overtime_minutes: 0, status: 'Đúng giờ', note: '' },
  { attendance_id: 'A014', work_date: '2026-02-02', employee_id: 'E003', shift_id: 'SH001', check_in: '08:00', check_out: '20:30', work_minutes: 510, overtime_minutes: 180, status: 'Tăng ca', note: 'Sprint review' },
  { attendance_id: 'A015', work_date: '2026-02-03', employee_id: 'E002', shift_id: 'SH001', check_in: '09:00', check_out: '17:30', work_minutes: 450, overtime_minutes: 0, status: 'Đi trễ', note: '' },
  { attendance_id: 'A016', work_date: '2026-02-03', employee_id: 'E004', shift_id: 'SH001', check_in: '08:00', check_out: '17:30', work_minutes: 510, overtime_minutes: 0, status: 'Đúng giờ', note: '' },
  { attendance_id: 'A017', work_date: '2026-02-04', employee_id: 'E001', shift_id: 'SH001', check_in: '', check_out: '', work_minutes: 0, overtime_minutes: 0, status: 'Nghỉ phép', note: 'Nghỉ phép năm đã duyệt' },
  { attendance_id: 'A018', work_date: '2026-02-10', employee_id: 'E006', shift_id: 'SH001', check_in: '08:00', check_out: '17:30', work_minutes: 510, overtime_minutes: 0, status: 'Đúng giờ', note: '' },
  { attendance_id: 'A019', work_date: '2026-02-11', employee_id: 'E007', shift_id: 'SH001', check_in: '08:10', check_out: '17:30', work_minutes: 499, overtime_minutes: 0, status: 'Đi trễ', note: '' },
  { attendance_id: 'A020', work_date: '2026-02-12', employee_id: 'E012', shift_id: 'SH001', check_in: '08:00', check_out: '19:00', work_minutes: 510, overtime_minutes: 90, status: 'Tăng ca', note: 'Chuẩn bị báo cáo quý' },
  { attendance_id: 'A021', work_date: '2026-02-24', employee_id: 'E001', shift_id: 'SH001', check_in: '07:50', check_out: '17:30', work_minutes: 520, overtime_minutes: 0, status: 'Đúng giờ', note: '' },
  { attendance_id: 'A022', work_date: '2026-02-25', employee_id: 'E003', shift_id: 'SH001', check_in: '08:00', check_out: '17:30', work_minutes: 510, overtime_minutes: 0, status: 'Đúng giờ', note: '' },
  { attendance_id: 'A023', work_date: '2026-02-26', employee_id: 'E005', shift_id: 'SH001', check_in: '08:30', check_out: '17:30', work_minutes: 480, overtime_minutes: 0, status: 'Đi trễ', note: '' },
  { attendance_id: 'A024', work_date: '2026-02-27', employee_id: 'E001', shift_id: 'SH001', check_in: '07:55', check_out: '17:32', work_minutes: 517, overtime_minutes: 0, status: 'Đúng giờ', note: '' },
  { attendance_id: 'A025', work_date: '2026-02-28', employee_id: 'E001', shift_id: 'SH001', check_in: '07:58', check_out: '17:30', work_minutes: 510, overtime_minutes: 0, status: 'Đúng giờ', note: '' },
  { attendance_id: 'A026', work_date: '2026-02-28', employee_id: 'E002', shift_id: 'SH001', check_in: '08:02', check_out: '17:30', work_minutes: 508, overtime_minutes: 0, status: 'Đúng giờ', note: '' },
  { attendance_id: 'A027', work_date: '2026-02-28', employee_id: 'E003', shift_id: 'SH001', check_in: '07:55', check_out: '20:00', work_minutes: 510, overtime_minutes: 150, status: 'Tăng ca', note: 'Go-live preparation' },
  { attendance_id: 'A028', work_date: '2026-02-28', employee_id: 'E004', shift_id: 'SH001', check_in: '08:00', check_out: '17:30', work_minutes: 510, overtime_minutes: 0, status: 'Đúng giờ', note: '' },
  { attendance_id: 'A029', work_date: '2026-02-28', employee_id: 'E006', shift_id: 'SH001', check_in: '08:00', check_out: '17:30', work_minutes: 510, overtime_minutes: 0, status: 'Đúng giờ', note: '' },
  { attendance_id: 'A030', work_date: '2026-02-28', employee_id: 'E009', shift_id: 'SH001', check_in: '08:15', check_out: '17:30', work_minutes: 495, overtime_minutes: 0, status: 'Đi trễ', note: '' },
]
...
export const mockPayrolls: Payroll[] = [
  { payroll_id: 'PY001', version: 1, period_id: 'PRP_202601', month: '2026-01', employee_id: 'E001', base_salary: 35000000, work_days_standard: 23, work_days_actual: 22, overtime_hours: 0, overtime_pay: 0, allowance: 1300000, deduction: 0, gross_pay: 34608695 + 1300000, insurance: 3675000, pit: 2800000, net_pay: 29433695, pay_date: '2026-02-05', status: 'Đã thanh toán' },
  { payroll_id: 'PY002', version: 1, period_id: 'PRP_202601', month: '2026-01', employee_id: 'E002', base_salary: 18000000, work_days_standard: 23, work_days_actual: 22, overtime_hours: 0, overtime_pay: 0, allowance: 0, deduction: 300000, gross_pay: 17217391 - 300000, insurance: 1890000, pit: 0, net_pay: 15027391, pay_date: '2026-02-05', status: 'Đã thanh toán' },
  { payroll_id: 'PY003', version: 1, period_id: 'PRP_202601', month: '2026-01', employee_id: 'E003', base_salary: 55000000, work_days_standard: 23, work_days_actual: 23, overtime_hours: 4.5, overtime_pay: 2898913, allowance: 5000000, deduction: 0, gross_pay: 55000000 + 2898913 + 5000000, insurance: 5775000, pit: 8500000, net_pay: 48623913, pay_date: '2026-02-05', status: 'Đã thanh toán' },
  { payroll_id: 'PY004', version: 1, period_id: 'PRP_202601', month: '2026-01', employee_id: 'E004', base_salary: 22000000, work_days_standard: 23, work_days_actual: 23, overtime_hours: 0, overtime_pay: 0, allowance: 0, deduction: 0, gross_pay: 22000000, insurance: 2310000, pit: 500000, net_pay: 19190000, pay_date: '2026-02-05', status: 'Đã thanh toán' },
  { payroll_id: 'PY005', version: 1, period_id: 'PRP_202601', month: '2026-01', employee_id: 'E006', base_salary: 45000000, work_days_standard: 23, work_days_actual: 23, overtime_hours: 0, overtime_pay: 0, allowance: 8000000, deduction: 0, gross_pay: 53000000, insurance: 4725000, pit: 9200000, net_pay: 39075000, pay_date: '2026-02-05', status: 'Đã thanh toán' },
  { payroll_id: 'PY006', version: 1, period_id: 'PRP_202601', month: '2026-01', employee_id: 'E009', base_salary: 38000000, work_days_standard: 23, work_days_actual: 23, overtime_hours: 0, overtime_pay: 0, allowance: 0, deduction: 0, gross_pay: 38000000, insurance: 3990000, pit: 5000000, net_pay: 29010000, pay_date: '2026-02-05', status: 'Đã thanh toán' },
  { payroll_id: 'PY007', version: 1, period_id: 'PRP_202601', month: '2026-01', employee_id: 'E012', base_salary: 42000000, work_days_standard: 23, work_days_actual: 22, overtime_hours: 1.5, overtime_pay: 561957, allowance: 0, deduction: 0, gross_pay: 41608695 + 561957, insurance: 4410000, pit: 6500000, net_pay: 31260652, pay_date: '2026-02-05', status: 'Đã thanh toán' },
  { payroll_id: 'PY008', version: 1, period_id: 'PRP_202602', month: '2026-02', employee_id: 'E001', base_salary: 35000000, work_days_standard: 20, work_days_actual: 18, overtime_hours: 0, overtime_pay: 0, allowance: 800000, deduction: 0, gross_pay: 31500000 + 800000, insurance: 3675000, pit: 2300000, net_pay: 26325000, pay_date: '2026-03-05', status: 'Chưa thanh toán' },
  { payroll_id: 'PY009', version: 1, period_id: 'PRP_202602', month: '2026-02', employee_id: 'E003', base_salary: 55000000, work_days_standard: 20, work_days_actual: 20, overtime_hours: 5.5, overtime_pay: 3781250, allowance: 1000000, deduction: 0, gross_pay: 59781250, insurance: 5775000, pit: 9200000, net_pay: 44806250, pay_date: '2026-03-05', status: 'Chưa thanh toán' },
  { payroll_id: 'PY010', version: 1, period_id: 'PRP_202602', month: '2026-02', employee_id: 'E012', base_salary: 42000000, work_days_standard: 20, work_days_actual: 20, overtime_hours: 1.5, overtime_pay: 472500, allowance: 4000000, deduction: 0, gross_pay: 46472500, insurance: 4410000, pit: 6800000, net_pay: 35262500, pay_date: '2026-03-05', status: 'Đang xử lý' },
]
